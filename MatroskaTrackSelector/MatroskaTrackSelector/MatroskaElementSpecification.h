...
#define CRC_32_TYPE (Buffer)
#define Void_ID (0xec)
#define Void_TYPE (Buffer)
...
#define BlockAdditional_TYPE (Buffer)
...
#define EncryptedBlock_TYPE (Buffer)
...
#define BlockAddIDExtraData_TYPE (Buffer)
...
#define CodecPrivate_TYPE (Buffer)
...
#define TrackTranslateTrackID_TYPE (Buffer)
...
#define UncompressedFourCC_TYPE (Buffer)
...
#define ProjectionPrivate_TYPE (Buffer)
...
#define ChannelPositions_TYPE (Buffer)
...
#define TrickTrackSegmentUID_TYPE (Buffer)
...
#define TrickMasterTrackSegmentUID_TYPE (Buffer)
...
#define ContentCompSettings_TYPE (Buffer)
...
#define ContentEncKeyID_TYPE (Buffer)
...
#define ContentSignature_TYPE (Buffer)
#define ContentSigKeyID_ID (0x47e4)
#define ContentSigKeyID_TYPE (Buffer)
...
#define ChapterSegmentUID_TYPE (Buffer)
...
#define ChapProcessPrivate_TYPE (Buffer)
...
#define ChapProcessData_TYPE (Buffer)
