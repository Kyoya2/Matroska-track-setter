...
bool AutomaticTrackSelector::mark_subtitle_track_for_selection(const size_t track_index)
{
...
bool AutomaticTrackSelector::mark_audio_track_for_selection(const size_t track_index)
{
